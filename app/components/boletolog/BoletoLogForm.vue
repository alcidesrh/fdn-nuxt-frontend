<template>
  <form class="py-4" @submit.prevent="emitSubmit">
    <div class="mb-2">
      <label for="boletolog_boleto" class="text-gray-700 block text-sm font-bold capitalize">
        boleto
      </label>
      <input id="boletolog_boleto" v-model="item.boleto" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
        violations?.boleto ? 'border-red-500' : 'border-gray-300',
      ]" type="text" placeholder="" />
      <div v-if="violations?.boleto" class="bg-red-100 rounded py-4 px-4 my-2 text-red-700 text-sm">
        {{ violations.boleto }}
      </div>
    </div>
    <div class="mb-2">
      <label for="boletolog_tipo" class="text-gray-700 block text-sm font-bold capitalize">
        tipo
      </label>
      <input id="boletolog_tipo" v-model="item.tipo" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label for="boletolog_createdAt" class="text-gray-700 block text-sm font-bold capitalize">
        createdAt
      </label>
      <input id="boletolog_createdAt" v-model="item.createdAt" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label for="boletolog_updatedAt" class="text-gray-700 block text-sm font-bold capitalize">
        updatedAt
      </label>
      <input id="boletolog_updatedAt" v-model="item.updatedAt" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label for="boletolog_descripcion" class="text-gray-700 block text-sm font-bold capitalize">
        descripcion
      </label>
      <input id="boletolog_descripcion" v-model="item.descripcion" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label for="boletolog_user" class="text-gray-700 block text-sm font-bold capitalize">
        user
      </label>
      <input id="boletolog_user" v-model="item.user" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label for="boletolog_id" class="text-gray-700 block text-sm font-bold capitalize">
        id
      </label>
      <input id="boletolog_id" v-model="item.id" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label for="boletolog_label" class="text-gray-700 block text-sm font-bold capitalize">
        label
      </label>
      <input id="boletolog_label" v-model="item.label" :class="[
        'mt-1 w-full px-3 py-2 border rounded',

<template>
  <form class="py-4" @submit.prevent="emitSubmit">
    ...
    <div class="mb-2">
      <label for="factura_id" class="text-gray-700 block text-sm font-bold capitalize">
        id
      </label>
      <input id="factura_id" v-model="item.id" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label for="factura_label" class="text-gray-700 block text-sm font-bold capitalize">
        label
      </label>
      <input id="factura_label" v-model="item.label" :class="[
        'mt-1 w-full px-3 py-2 border rounded',

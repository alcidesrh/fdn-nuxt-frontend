<template>
  <form class="py-4" @submit.prevent="emitSubmit">
    ...
    <div class="mb-2">
      ...
      <FormRepeater
        :values="item.venta"
        @update="(values: any[]) => (item.venta = values)"
      />
      <div
        v-if="violations?.venta"
        class="bg-red-100 rounded py-4 px-4 my-2 text-red-700 text-sm"
      >
        {{ violations.venta }}
      </div>
    ...
    <div class="mb-2">
      <label
        for="factura_createdAt"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        createdAt
      </label>
      <input
        id="factura_createdAt"
    ...
    <div class="mb-2">
      <label
        for="factura_updatedAt"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        updatedAt
      </label>
      <input
        id="factura_updatedAt"

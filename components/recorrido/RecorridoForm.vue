<template>
  <form class="py-4" @submit.prevent="emitSubmit">
    ...
    <div class="mb-2">
      <label
        for="recorrido_distancia"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        distancia
      </label>
      <input
        id="recorrido_distancia"
        v-model="item.distancia"
        :class="[
          'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label
        for="recorrido_paradas"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        paradas
      </label>
      <input
        id="recorrido_paradas"
        v-model="item.paradas"
        :class="[
          'mt-1 w-full px-3 py-2 border rounded',
    ...
    <div class="mb-2">
      <label
        for="recorrido_legacyId"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        legacyId
      </label>
      <input
        id="recorrido_legacyId"

<template>
  <form class="py-4" @submit.prevent="emitSubmit">
    <div class="mb-2">
      <label
        for="recorridoasientoprecio_recorrido"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        recorrido
      </label>
      <input
        id="recorridoasientoprecio_recorrido"
        v-model="item.recorrido"
        :class="[
    ...
    <div class="mb-2">
      <label
        for="recorridoasientoprecio_precioAsientoA"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        precioAsientoA
      </label>
      <input
        id="recorridoasientoprecio_precioAsientoA"
        v-model="item.precioAsientoA"
        :class="[
          'mt-1 w-full px-3 py-2 border rounded',
      ...
      />
      <div
        v-if="violations?.precioAsientoA"
        class="bg-red-100 rounded py-4 px-4 my-2 text-red-700 text-sm"
      >
    ...
    <div class="mb-2">
      <label
        for="recorridoasientoprecio_precioAsientoB"
        class="text-gray-700 block text-sm font-bold capitalize"
      >
        precioAsientoB
      </label>
      <input
        id="recorridoasientoprecio_precioAsientoB"
        v-model="item.precioAsientoB"
        :class="[
          'mt-1 w-full px-3 py-2 border rounded',
      ...
      />
      <div
        v-if="violations?.precioAsientoB"
        class="bg-red-100 rounded py-4 px-4 my-2 text-red-700 text-sm"
      >

...
/**
  ...
  *
  * @checksum - 271aa7c09c1bb1eff2e68ea293fbd09c2f49181b784174dbd45e380a11626e93
  * @variables - undefined
  * @theme - fdnformkittheme
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "peer-checked:text-slate-900": true,
    "peer-disabled:cursor-not-allowed": true,
    "peer-focus:ring-2": true,
    "dark:border-slate-100": true,
    "dark:peer-checked:text-slate-100": true
  },
  ...
  "family:dropdown__loadMore": {
    "data-[is-active]:bg-slate-100": true
  },
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:border-slate-700": true,
    "group-data-[overscroll]:dark:border-slate-100": true
  },
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-slate-300": true,
    ...
    "dark:text-slate-100": true,
    "dark:data-[is-active]:bg-slate-700": true,
    "dark:data-[is-active]:before:ring-slate-400": true,
  ...
  "select__input": {
    ...
    "group-data-[prefix-icon]:!pl-0": true,
    "group-data-[suffix-icon]:!pr-0": true,
    "data-[placeholder]:text-slate-700": true,
    "dark:text-slate-100": true,
    "dark:data-[placeholder]:text-slate-100": true,
    "border-none": true,
    "focus:ring-0": true,
    "bg-none": true
  },
  ...
  "autocomplete__selectionWrapper": {
    ...
    "group-data-[multiple]:border-slate-700": true,
    "group-data-[multiple]:mb-1.5": true,
    "outline-none": true,
    "data-[active-selection=true]:ring-2": true,
    "dark:bg-slate-700": true,
    "dark:group-data-[multiple]:border-slate-100": true,
  ...
  "colorpicker__fieldGroup": {
    ...
    "dark:[&>input]:text-slate-100": true,
    "dark:[&>input]:border-slate-100": true
  },
  ...
  "datepicker__calendarIcon": {
    "text-slate-600": true,
    "focus-visible:text-slate-900": true,
    "flex": true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
    ...
    "[&>svg]:max-w-[1em]": true,
    "dark:text-slate-400": true,
    "dark:focus-visible:text-slate-100": true
  },
  ...
  "datepicker__month": {
    ...
    "text-slate-700": true,
    "bg-transparent": true,
    "aria-selected:!bg-slate-900": true,
    ...
    "dark:text-slate-100": true,
    "dark:aria-selected:!bg-slate-100": true,
  ...
  "dropdown__selector": {
    ...
    "dark:text-slate-100": true,
    "dark:data-[placeholder]:text-slate-500": true
  },
  ...
  "mask__input": {
    ...
    "dark:group-data-[has-overlay]:!caret-slate-100": true
  },
  "mask__overlay": {
    "text-slate-700": true,
    "dark:text-slate-100": true
  ...
  "rating__ratingItem": {
    ...
    "focus-within:outline-slate-900": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true
  },
  ...
  "repeater__controls": {
    ...
    "[&>li]:aspect-[1/1]": true,
    "[&>li]:text-slate-500": true,
    "[&>li:hover]:text-slate-600": true,
    "group-data-[disabled]/repeater:[&>li_button]:opacity-50": true,
    "group-data-[disabled]/repeater:[&>li_button]:!text-slate-500": true,
    "group-data-[disabled]/repeater:[&>li_button]:pointer-events-none": true,
    "dark:[&>li]:text-slate-500": true,
    "dark:[&>li:hover]:text-slate-200": true
  },
  "repeater__upControl": {
    "": true
  },
  ...
  "slider__chartBar": {
    ...
    "h-full": true,
    "bg-slate-400": true,
    "data-[active=true]:bg-slate-700": true,
    "dark:bg-slate-700": true,
    "dark:data-[active=true]:bg-slate-100": true
  },
  ...
  "slider__mark": {
    ...
    "dark:bg-slate-400": true,
    "dark:data-[active=true]:bg-slate-600": true
  },
  "slider__markLabel": {
    "absolute": true,
  ...
  "slider__tooltip": {
    ...
    "after:border-t-slate-900": true,
    "dark:after:border-t-slate-100": true
  },
  ...
  "toggle__track": {
    ...
    "peer-checked:bg-slate-900": true,
    ...
    "dark:peer-checked:bg-slate-100": true
  },
  "toggle__innerLabel": {
    "absolute": true,
    "text-white": true,
  ...
  "togglebuttons__input": {
    ...
    "aria-[pressed=true]:bg-slate-900": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-slate-100": true,
  ...
  "transferlist__outer": {
    ...
    "data-[disabled]:pointer-events-none": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-slate-900": true,
    "&_.dnd-placeholder]:text-white": true,
    "dark:[&_.dnd-placeholder]:bg-slate-100": true,
    "dark:[&_.dnd-placeholder]:text-slate-900": true
  },
  ...
  "transferlist__transferlistListItem": {
    ...
    "ring-1": true,
    "ring-slate-700": true,
    "aria-selected:bg-slate-100": true,
    "data-[is-active=true]:bg-slate-100": true,
    "relative": true,
    "flex": true,
    "items-center": true,
    "pl-[1.5em]": true,
    "[&.formkit-dropZone]:bg-slate-100": true,
    "[&.formkit-selectionDropZone]:bg-slate-100": true,
    "[&.formkit-touchDropZone]:bg-slate-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-slate-100": true,
    "[&.formkit-longTouch]:bg-slate-100": true,
    "dark:bg-slate-900": true,
    "dark:text-slate-100": true,
    "dark:aria-selected:bg-slate-700": true,
    "dark:data-[is-active=true]:bg-slate-700": true,
    "dark:ring-slate-100": true
  },
  ...
  "transferlist__transferlistButton": {
    ...
    "disabled:opacity-50": true,
    "dark:text-slate-100": true,
    "dark:disabled:!text-slate-500": true
  },
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=tab]/wrapper:border-slate-700": true,
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-slate-100": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=tab]/wrapper:bg-slate-50": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-slate-700": true,
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-slate-900": true,
    "group-data-[tab-style=progress]/wrapper:last:after:hidden": true,
    "dark:group-data-[tab-style=progress]/wrapper:after:bg-slate-700": true,
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-slate-300": true
  },

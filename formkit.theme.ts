 ...
 *
 * @checksum - 72664d7bd434beac0b2b0b2c334aa059fe8e08089d061728f1e40b9d19788b29
 * @variables - undefined
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
    ...
    'family:box__decorator': {
        ...
        'bg-white': true,
        'ring-neutral-500': true,
        'peer-checked:border-neutral-600': true,
        relative: true,
        block: true,
        'text-lg': true,
        'w-[1em]': true,
        ...
        'peer-checked:bg-neutral-50': true,
        'peer-checked:text-neutral-600': true,
        ...
        'dark:ring-offset-neutral-500': true,
        'dark:peer-focus-visible:ring-1': true,
        'dark:peer-disabled:bg-neutral-600/50': true,
        'dark:peer-checked:bg-neutral-900': true,
        'dark:peer-checked:text-neutral-400': true
    },
    ...
    'family:text__inner': {
        ...
        'focus-within:!ring-neutral-500': true,
        'focus-within:!border-neutral-500': true,
    ...
    'family:dropdown__listitem': {
        ...
        'data-[is-active]:before:ring-neutral-500': true,
        'data-[is-active]:before:ring-inset': true,
        'data-[is-active]:before:ring-offset-neutral-100': true,
    ...
    'family:dropdown__loadMoreInner': {
        ...
        'cursor-pointer': true,
        'dark:text-neutral-200': true,
        'dark:hover:text-neutral-500': true
    },
    ...
    'family:dropdown__tagWrapper': {
        ...
        'data-[active-selection=true]:ring-neutral-500': true
    },
    ...
    'family:dropdown__tag': {
        ...
        'group-data-[active-selection=true]/tag:bg-neutral-400': true,
    ...
    'family:dropdown__emptyMessage': {
        ...
        'aria-selected:bg-neutral-600': true
    },
    button__input: {
        'appearance-none': true,
        '[color-scheme:light]': true,
        ...
        'dark:bg-transparent': true,
        'dark:hover:bg-neutral-50/5': true
    },
    checkbox__decorator: {
        rounded: true
    },
    ...
    date__input: {
        ...
        'selection:text-neutral-700': true,
        'group-data-[has-overlay]:selection:!text-transparent': true,
        'focus:[&::-webkit-datetime-edit-day-field]:bg-neutral-100': true,
        'focus:[&::-webkit-datetime-edit-month-field]:bg-neutral-100': true,
        'focus:[&::-webkit-datetime-edit-year-field]:bg-neutral-100': true
    },
    'datetime-local__input': {
        ...
        'focus:[&::-webkit-datetime-edit-month-field]:bg-neutral-100': true,
        'focus:[&::-webkit-datetime-edit-year-field]:bg-neutral-100': true,
        'focus:[&::-webkit-datetime-edit-hour-field]:bg-neutral-100': true,
        'focus:[&::-webkit-datetime-edit-minute-field]:bg-neutral-100': true,
        'focus:[&::-webkit-datetime-edit-ampm-field]:bg-neutral-100': true
    },
    file__fileList: {
        'group/list': true,
        peer: true,
    ...
    file__fileRemove: {
        ...
        'peer-data-[has-multiple]:text-neutral-600': true,
    ...
    form__messageLink: {
        ...
        'group-[]/summary:ring-neutral-600': true
    },
    month__input: {
        'appearance-none': true,
        '[color-scheme:light]': true,
    ...
    range__input: {
        ...
        '[&::-webkit-slider-thumb]:focus:!ring-neutral-500': true,
        ...
        '[&::-moz-range-thumb]:focus:!ring-neutral-500': true,
    ...
    select__option: {
        ...
        'group-data-[multiple]:checked:bg-neutral-100': true,
        'group-data-[multiple]:focus:bg-neutral-100': true,
        ...
        'dark:bg-neutral-800': true,
        'dark:text-neutral-300': true,
        'dark:group-data-[multiple]:focus:bg-neutral-800': true,
        'dark:group-data-[multiple]:checked:bg-neutral-800': true
    },
    select__prefixIcon: {
        flex: true,
        'items-center': true,
    ...
    submit__input: {
        ...
        'bg-neutral-600': true,
        '!text-white': true,
        'active:text-neutral-100': true,
        'active:bg-neutral-700': true,
    ...
    week__input: {
        ...
        'selection:text-neutral-700': true,
        'group-data-[has-overlay]:selection:!text-transparent': true,
        'focus:[&::-webkit-datetime-edit-week-field]:bg-neutral-100': true,
        'focus:[&::-webkit-datetime-edit-year-field]:bg-neutral-100': true
    },
    ...
    colorpicker__control: {
        ...
        'focus-visible:ring-neutral-500': true
    },
    ...
    colorpicker__fieldGroup: {
        ...
        '[&>input]:selection:bg-neutral-100': true,
        '[&>input]:m-0': true,
        '[&>input]:grow': true,
        '[&>input]:shrink': true,
        '[&>input]:w-full': true,
        ...
        '[&>input:focus]:ring-neutral-600': true,
        '[&>input:focus]:border-neutral-600': true,
    ...
    colorpicker__swatch: {
        ...
        '[&>canvas:focus-visible]:ring-neutral-500': true,
    ...
    datepicker__month: {
        ...
        'focus:outline-neutral-600': true,
    ...
    datepicker__dayCell: {
        ...
        'dark:bg-neutral-600': true,
        'dark:text-neutral-300': true,
        'dark:aria-selected:bg-neutral-600': true,
        'dark:aria-selected:text-white': true,
        'dark:focus:outline-neutral-600': true,
    ...
    datepicker__timeInput: {
        ...
        'p-1.5': true,
        'my-2.5': true,
        'focus-visible:outline-neutral-600': true,
        'dark:text-neutral-300': true,
        'dark:bg-transparent': true,
        'dark:border-neutral-600': true
    },
    ...
    datepicker__dayButton: {
        ...
        'dark:text-neutral-300': true,
        'dark:border-neutral-600': true,
        'dark:hover:border-neutral-500': true
    },
    ...
    datepicker__calendarIcon: {
        'text-neutral-600': true,
        'focus-visible:text-neutral-600': true,
        flex: true,
        'w-[1em]': true,
        'grow-0': true,
        'shrink-0': true,
    ...
    rating__ratingItem: {
        ...
        'focus-within:outline-neutral-600': true,
        'w-[1.5em]': true,
        'h-[1.5em]': true
    },
    ...
    slider__tooltip: {
        ...
        'after:border-t-neutral-600': true,
    ...
    toggle__track: {
        ...
        'transition-all': true,
        'bg-neutral-400': true,
        'peer-checked:bg-neutral-600': true,
        ...
        'shadow-sm': true,
        'peer-focus-visible:ring-2': true,
        'peer-focus-visible:ring-neutral-500': true,
    ...
    togglebuttons__input: {
        ...
        'dark:text-neutral-500': true,
        'aria-[pressed=true]:bg-neutral-600': true,
        'aria-[pressed=true]:text-white': true,
        'dark:aria-[pressed=true]:bg-neutral-600': true,
    ...
    transferlist__outer: {
        ...
        'text-base': true,
        'max-w-none': true,
        '[&_.dnd-placeholder]:bg-neutral-600': true,
    ...
    transferlist__transferlist: {
        ...
        '[&:has(:focus-visible)]:ring-neutral-500': true,
        'dark:border-neutral-600': true,
    ...
    transferlist__transferlistListItem: {
        ...
        'data-[is-active=true]:ring-neutral-200': true,
        'aria-selected:ring-neutral-200': true,
        relative: true,
        flex: true,
        'cursor-pointer': true,
        'items-center': true,
        ...
        'dark:bg-neutral-800': true,
        'dark:text-neutral-300': true,
        'dark:data-[is-active=true]:bg-neutral-900': true,
        'dark:aria-selected:bg-neutral-900': true,
        'dark:ring-neutral-700': true,
        'dark:data-[is-active=true]:ring-neutral-600': true,
        'dark:aria-selected:ring-neutral-600': true,
        ...
        'dark:[&.formkit-dropZone]:bg-neutral-900': true,
        'dark:[&.formkit-selectionDropZone]:bg-neutral-900': true,
        'dark:[&.formkit-touchDropZone]:bg-neutral-900': true,
        'dark:[&.formkit-touchSelectionDropZone]:bg-neutral-900': true,
        'dark:[&.formkit-longTouch]:bg-neutral-900': true
    },
    ...
    transferlist__transferlistSearch: {
        ...
        'dark:border-neutral-600': true,
        'dark:text-neutral-300': true,
        'dark:selection:bg-neutral-100': true,
        'dark:selection:text-neutral-700': true,
        'dark:bg-neutral-800': true
    },
    ...
    'multi-step__tab': {
        ...
        'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-neutral-600': true,
        ...
        'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-neutral-600': true
    },
    ...
    'multi-step__badge': {
        ...
        'text-white': true,
        'rounded-full': true,
        'group-data-[valid=true]/tab:bg-neutral-600': true,

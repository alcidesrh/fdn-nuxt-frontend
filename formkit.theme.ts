 ...
 *
 * @checksum - de9a598895cd2fcc9dc2e9b7edc0182ba06935a4133672568a3c994e5c17b5b6
 * @variables - undefined
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:box__decorator': {
    ...
    'bg-white': true,
    'ring-yellow-500': true,
    'peer-checked:border-yellow-600': true,
    relative: true,
    block: true,
    'text-lg': true,
    'w-[1em]': true,
    ...
    'peer-checked:bg-yellow-50': true,
    'peer-checked:text-yellow-600': true,
    ...
    'dark:ring-offset-yellow-500': true,
    'dark:peer-focus-visible:ring-1': true,
    'dark:peer-disabled:bg-neutral-600/50': true,
    'dark:peer-checked:bg-yellow-900': true,
    'dark:peer-checked:text-yellow-400': true,
  },
  ...
  'family:text__inner': {
    ...
    'focus-within:!ring-yellow-500': true,
    'focus-within:!border-yellow-500': true,
  ...
  'family:dropdown__listitem': {
    ...
    'text-neutral-700': true,
    'text-base': true,
    'data-[is-active]:bg-yellow-100': true,
    ...
    'data-[is-active]:before:ring-yellow-500': true,
    'data-[is-active]:before:ring-inset': true,
    'data-[is-active]:before:ring-offset-yellow-100': true,
  ...
  'family:dropdown__loadMoreInner': {
    ...
    'cursor-pointer': true,
    'dark:text-neutral-200': true,
    'dark:hover:text-yellow-500': true,
  },
  ...
  'family:dropdown__tagWrapper': {
    ...
    'data-[active-selection=true]:ring-yellow-500': true,
  },
  ...
  'family:dropdown__tag': {
    ...
    'group-data-[active-selection=true]/tag:bg-yellow-400': true,
  ...
  'family:dropdown__emptyMessage': {
    ...
    'aria-selected:bg-yellow-600': true,
  },
  button__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
    ...
    'dark:text-yellow-500': true,
    'dark:bg-transparent': true,
    'dark:hover:bg-yellow-50/5': true,
  },
  checkbox__decorator: {
    rounded: true,
  },
  ...
  date__input: {
    ...
    'selection:text-neutral-700': true,
    'group-data-[has-overlay]:selection:!text-transparent': true,
    'focus:[&::-webkit-datetime-edit-day-field]:bg-yellow-100': true,
    'focus:[&::-webkit-datetime-edit-month-field]:bg-yellow-100': true,
    'focus:[&::-webkit-datetime-edit-year-field]:bg-yellow-100': true,
  },
  'datetime-local__input': {
    ...
    'focus:[&::-webkit-datetime-edit-month-field]:bg-yellow-100': true,
    'focus:[&::-webkit-datetime-edit-year-field]:bg-yellow-100': true,
    'focus:[&::-webkit-datetime-edit-hour-field]:bg-yellow-100': true,
    'focus:[&::-webkit-datetime-edit-minute-field]:bg-yellow-100': true,
    'focus:[&::-webkit-datetime-edit-ampm-field]:bg-yellow-100': true,
  },
  file__fileList: {
    'group/list': true,
    peer: true,
  ...
  file__fileRemove: {
    ...
    'peer-data-[has-multiple]:text-yellow-600': true,
  ...
  form__messageLink: {
    ...
    'group-[]/summary:ring-yellow-600': true,
  },
  month__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  range__input: {
    ...
    '[&::-webkit-slider-thumb]:bg-yellow-600': true,
    ...
    '[&::-webkit-slider-thumb]:focus:!ring-yellow-500': true,
    ...
    '[&::-moz-range-thumb]:bg-yellow-600': true,
    ...
    '[&::-moz-range-thumb]:focus:!ring-yellow-500': true,
  ...
  select__option: {
    ...
    'group-data-[multiple]:checked:bg-yellow-100': true,
    'group-data-[multiple]:focus:bg-yellow-100': true,
    ...
    'dark:bg-neutral-800': true,
    'dark:text-neutral-300': true,
    'dark:group-data-[multiple]:focus:bg-yellow-800': true,
    'dark:group-data-[multiple]:checked:bg-yellow-800': true,
  },
  select__prefixIcon: {
    flex: true,
    'items-center': true,
  ...
  submit__input: {
    ...
    'bg-yellow-600': true,
    '!text-white': true,
    'active:text-yellow-100': true,
    'active:bg-yellow-700': true,
  ...
  week__input: {
    ...
    'selection:text-neutral-700': true,
    'group-data-[has-overlay]:selection:!text-transparent': true,
    'focus:[&::-webkit-datetime-edit-week-field]:bg-yellow-100': true,
    'focus:[&::-webkit-datetime-edit-year-field]:bg-yellow-100': true,
  },
  ...
  colorpicker__control: {
    ...
    'focus-visible:ring-yellow-500': true,
  },
  ...
  colorpicker__fieldGroup: {
    ...
    '[&>input]:selection:bg-yellow-100': true,
    '[&>input]:m-0': true,
    '[&>input]:grow': true,
    '[&>input]:shrink': true,
    '[&>input]:w-full': true,
    ...
    '[&>input:focus]:ring-yellow-600': true,
    '[&>input:focus]:border-yellow-600': true,
  ...
  colorpicker__swatch: {
    ...
    '[&>canvas:focus-visible]:ring-yellow-500': true,
  ...
  datepicker__dayCell: {
    ...
    'dark:bg-neutral-600': true,
    'dark:text-neutral-300': true,
    'dark:aria-selected:bg-yellow-600': true,
    'dark:aria-selected:text-white': true,
    'dark:focus:outline-yellow-600': true,
  ...
  datepicker__timeInput: {
    ...
    'p-1.5': true,
    'my-2.5': true,
    'focus-visible:outline-yellow-600': true,
    'dark:text-neutral-300': true,
    'dark:bg-transparent': true,
    'dark:border-neutral-600': true,
  },
  ...
  datepicker__dayButton: {
    ...
    'dark:text-neutral-300': true,
    'dark:border-neutral-600': true,
    'dark:hover:border-yellow-500': true,
  },
  ...
  datepicker__calendarIcon: {
    'text-neutral-600': true,
    'focus-visible:text-yellow-600': true,
    flex: true,
    'w-[1em]': true,
    'grow-0': true,
    'shrink-0': true,
  ...
  rating__ratingItem: {
    ...
    'focus-within:outline-yellow-600': true,
    'w-[1.5em]': true,
    'h-[1.5em]': true,
  },
  ...
  slider__tooltip: {
    ...
    'after:border-t-yellow-600': true,
  ...
  toggle__track: {
    ...
    'transition-all': true,
    'bg-neutral-400': true,
    'peer-checked:bg-yellow-600': true,
    ...
    'shadow-sm': true,
    'peer-focus-visible:ring-2': true,
    'peer-focus-visible:ring-yellow-500': true,
  ...
  togglebuttons__input: {
    ...
    'dark:disabled:text-yellow-500': true,
    'dark:text-yellow-500': true,
    'aria-[pressed=true]:bg-yellow-600': true,
    'aria-[pressed=true]:text-white': true,
    'dark:aria-[pressed=true]:bg-yellow-600': true,
    ...
    'group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-yellow-500': true,
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-yellow-600': true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-yellow-600': true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-yellow-600': true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-yellow-600': true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-yellow-600': true,
    ...
    'group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-yellow-500': true,
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-yellow-600': true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-yellow-600': true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-yellow-600': true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-yellow-600': true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-yellow-600': true,
    // @unocss-skip-end
  },
  transferlist__outer: {
    group: true,
    ...
    'text-base': true,
    'max-w-none': true,
    '[&_.dnd-placeholder]:bg-yellow-600': true,
  ...
  transferlist__transferlist: {
    ...
    '[&:has(:focus-visible)]:ring-yellow-500': true,
    'dark:border-neutral-600': true,
  ...
  transferlist__transferlistListItem: {
    ...
    'aria-selected:bg-yellow-100': true,
    'data-[is-active=true]:bg-yellow-100': true,
    'data-[is-active=true]:ring-yellow-200': true,
    'aria-selected:ring-yellow-200': true,
    relative: true,
    flex: true,
    'cursor-pointer': true,
    'items-center': true,
    ...
    'dark:bg-neutral-800': true,
    'dark:text-neutral-300': true,
    'dark:data-[is-active=true]:bg-yellow-900': true,
    'dark:aria-selected:bg-yellow-900': true,
    'dark:ring-neutral-700': true,
    'dark:data-[is-active=true]:ring-yellow-600': true,
    'dark:aria-selected:ring-yellow-600': true,
    '[&.formkit-dropZone]:bg-yellow-100': true,
    '[&.formkit-selectionDropZone]:bg-yellow-100': true,
    '[&.formkit-touchDropZone]:bg-yellow-100': true,
    '[&.formkit-touchSelectionDropZone]:bg-yellow-100': true,
    '[&.formkit-longTouch]:bg-yellow-100': true,
    'dark:[&.formkit-dropZone]:bg-yellow-900': true,
    'dark:[&.formkit-selectionDropZone]:bg-yellow-900': true,
    'dark:[&.formkit-touchDropZone]:bg-yellow-900': true,
    'dark:[&.formkit-touchSelectionDropZone]:bg-yellow-900': true,
    'dark:[&.formkit-longTouch]:bg-yellow-900': true,
  },
  ...
  transferlist__transferlistSearch: {
    ...
    'dark:border-neutral-600': true,
    'dark:text-neutral-300': true,
    'dark:selection:bg-yellow-100': true,
    'dark:selection:text-neutral-700': true,
    'dark:bg-neutral-800': true,
  },
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-yellow-600': true,
    ...
    'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-yellow-600': true,
  },
  ...
  'multi-step__badge': {
    ...
    'text-white': true,
    'rounded-full': true,
    'group-data-[valid=true]/tab:bg-yellow-600': true,

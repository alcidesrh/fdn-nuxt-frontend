        ...
        <div class="flex flex-column align-items-center justify-content-center">
            <div
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
                    ...
                    <div class="p-gridflex flex-column align-items-center">
                        <div class="flex justify-content-center align-items-center bg-orange-500 border-circle"
                            style="width: 3.2rem; height: 3.2rem">
                            <i class="p-text-50 pi pi-fw pi-lock p-text-2xl"></i>
                        </div>
                        <h1 class="p-text-900 font-bold p-text-4xl lg:p-text-5xl mb-2">Access Denied</h1>
                        <span class="p-text-600 mb-5">You do not have the necessary permisions. Please contact
                            admins.</span>

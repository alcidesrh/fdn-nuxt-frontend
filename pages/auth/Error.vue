                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
                    ...
                    <div class="p-gridflex flex-column align-items-center">
                        <div class="flex justify-content-center align-items-center bg-pink-500 border-circle"
                            ...
                            <i class="pi pi-fw pi-exclamation-circle p-text-2xl text-white"></i>
                        </div>
                        <h1 class="p-text-900 font-bold p-text-5xl mb-2">Error Occured</h1>
                        <span class="p-text-600 mb-5">Requested resource is not available.</span>
